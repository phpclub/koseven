...
/**
 * Tests the ko7 text class (KO7_Text)
 *
 * @group ko7
 * @group ko7.core
 * @group ko7.core.text
 ...
 * @category   Tests
 */
class KO7_TextTest extends Unittest_TestCase
{
	...
	function provider_censor()
	{
		...
		return [
				...
				["Cake### isn't nearly as good as ko7###", "CakePHP isn't nearly as good as ko7php", ['php'], '#', TRUE],
	...
	function provider_widont()
	{
		return [
			 ...
			 * array(
			 * 		'with HTML at the end &nbsp;<strong>KO7</strong>',
			 * 		'with HTML at the end <strong>KO7</strong>',
			 * 	),
			 * 	// @issue 3499, with HTML with attributes at the end
			 * 	array(
			 * 		'with HTML at the end:&nbsp;<a href="#" title="KO7">KO7</a>',
			 * 		'with HTML at the end: <a href="#" title="KO7">KO7</a>',
			 * 	),
			 */
				[
