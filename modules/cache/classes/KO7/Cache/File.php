<?php
/**
 * [KO7 Cache](api/KO7_Cache) File driver. Provides a file based
 * driver for the KO7 Cache library. This is one of the slowest
 * caching methods.
 *
 ...
 *                  'cache_dir'     => APPPATH.'cache/.ko7_cache', // Cache location
 *           ),
 *     )
 *
...
class KO7_Cache_File extends Cache implements Cache_GarbageCollect {
	...
	protected function _check_cache_dir()
	{
		try
		{
			$directory = Arr::get($this->_config, 'cache_dir', KO7::$cache_dir);
